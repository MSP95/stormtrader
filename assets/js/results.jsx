...
export default function wait_init(root, winner, gamestate) {
  ...
  ReactDOM.render(
    <Result status={status} winner={winner} gamestate={gamestate} />, root);
}
      ...
      <div className="result">
        ...
        <div className="result-block">
          <div className="result-body">
            <div></div>
            <div className="result-status header">{this.props.status === "winner" ? "Winner is "+this.props.winner.name+"!" : "It is a tie!"}</div>
